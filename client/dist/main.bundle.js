...
var AppComponent = /** @class */ (function () {
    function AppComponent(loginService, matDialog, _profileService) {
    ...
    AppComponent.prototype.openLoginDialog = function () {
        var loginDialogRef = this.matDialog.open(__WEBPACK_IMPORTED_MODULE_3__login_login_component__["a" /* LoginComponent */], {
            width: 'auto',
            height: 'auto',
            maxWidth: '80%',
            maxHeight: '80%',
    ...
    AppComponent.prototype.openSignupDialog = function () {
        var signUpdialogRef = this.matDialog.open(__WEBPACK_IMPORTED_MODULE_2__signup_signup_component__["a" /* SignUpDialogComponent */], {
            width: 'auto',
            height: 'auto',
            maxWidth: '80%',
            maxHeight: '80%',
    ...
    AppComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_5__services_user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_1__angular_material__["d" /* MatDialog */], __WEBPACK_IMPORTED_MODULE_4__services_profile_service__["a" /* ProfileService */]])
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__services_profile_service__ = __webpack_require__("../../../../../src/app/services/profile.service.ts");
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["K" /* NgModule */])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_11__signup_signup_component__["a" /* SignUpDialogComponent */],
                __WEBPACK_IMPORTED_MODULE_14__login_login_component__["a" /* LoginComponent */]
            ],
            entryComponents: [__WEBPACK_IMPORTED_MODULE_11__signup_signup_component__["a" /* SignUpDialogComponent */], __WEBPACK_IMPORTED_MODULE_14__login_login_component__["a" /* LoginComponent */]],
            imports: [
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_13__services_profile_service__["a" /* ProfileService */], __WEBPACK_IMPORTED_MODULE_15__services_user_service__["a" /* UserService */]],
...
var UserService = /** @class */ (function () {
    function UserService(_httpClient) {
        ...
        this.userLoggedIn$ = this.loginRequest$.pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["e" /* switchMap */])(function (body) {
            return _this._httpClient.post(_this._baseUrl + "login", body, { withCredentials: true }).pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["a" /* map */])(function (value) {
                if (value.id) {
                    return true;
                }
                else {
