...
var Group = /** @class */ (function () {
    ...
    Group.prototype.initMatches = function () {
        this.matches = [];
        this.matches.push(new __WEBPACK_IMPORTED_MODULE_1__Match__["a" /* Match */](this.teams[0].name, this.teams[1].name));
        this.matches.push(new __WEBPACK_IMPORTED_MODULE_1__Match__["a" /* Match */](this.teams[2].name, this.teams[3].name));
        this.matches.push(new __WEBPACK_IMPORTED_MODULE_1__Match__["a" /* Match */](this.teams[0].name, this.teams[2].name));
        this.matches.push(new __WEBPACK_IMPORTED_MODULE_1__Match__["a" /* Match */](this.teams[3].name, this.teams[1].name));
        this.matches.push(new __WEBPACK_IMPORTED_MODULE_1__Match__["a" /* Match */](this.teams[3].name, this.teams[0].name));
        this.matches.push(new __WEBPACK_IMPORTED_MODULE_1__Match__["a" /* Match */](this.teams[1].name, this.teams[2].name));
    };
    ...
    Group.prototype.deserialize = function (input) {
        ...
        group.matches.forEach(function (match) {
            newMatches.push(__WEBPACK_IMPORTED_MODULE_1__Match__["a" /* Match */].deserialize(match));
        });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_Constants__ = __webpack_require__("../../../../../../api/src/shared/models/Constants.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_pronostiek_Tournament__ = __webpack_require__("../../../../../../api/src/shared/models/pronostiek/Tournament.ts");
...
function getTournament() {
    ...
    var tournament = new __WEBPACK_IMPORTED_MODULE_3__models_pronostiek_Tournament__["a" /* Tournament */]();
    var allTeams = [
    ...
    allTeams.forEach(function (groupTeamsNames, index) {
        ...
        var group = new __WEBPACK_IMPORTED_MODULE_1__models_pronostiek_Group__["a" /* Group */]("Group " + groupLetter[index], teams);
...
function proccesMatches(group) {
    ...
    group.matches.forEach(function (match) {
        if (match.outTeamScore != undefined && match.homeTeamScore != undefined) {
            //this means match is played, so let do what we need to do:
            var matchOutCome = match.getOutCome();
            var homeTeam = group.getTeam(match.homeTeamName);
            var outTeam = group.getTeam(match.outTeamName);
            if (matchOutCome == __WEBPACK_IMPORTED_MODULE_2__models_Constants__["b" /* HOME_TEAM_WINS */]) {
                homeTeam.points += 3;
                homeTeam.matchesWon++;
                outTeam.matchesLost++;
            }
            else if (matchOutCome == __WEBPACK_IMPORTED_MODULE_2__models_Constants__["d" /* OUT_TEAM_WINS */]) {
                outTeam.points += 3;
                outTeam.matchesWon++;
                homeTeam.matchesLost++;
            }
...
module.exports = "<div id=\"prono-save-button\">\n  <button mat-fab color=\"primary\" (click)=\"savePronosiek()\">Save</button>\n</div>\n\n<app-groups [groups]=\"(pronostiek$ | async)?.tournament?.groups\" (groupsChanged)=\"groupsChanged($event)\" ></app-groups>\n"
...
var PronostiekComponent = /** @class */ (function () {
    ...
    PronostiekComponent.prototype.ngOnInit = function () {
        ...
        this.pronostiek$ = this._userService.getPronostiek().pipe(Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["i" /* tap */])(function (value) { return _this.pronostiekToSave = value; }), Object(__WEBPACK_IMPORTED_MODULE_2_rxjs_operators__["c" /* merge */])(this.pronostiekSaved$));
    };
